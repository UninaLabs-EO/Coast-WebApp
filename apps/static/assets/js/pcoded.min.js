...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://github.com/UninaLabs-EO" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> Our Repositories' +
    '</a> ' + '</div>' + '');
var $window = $(window);
